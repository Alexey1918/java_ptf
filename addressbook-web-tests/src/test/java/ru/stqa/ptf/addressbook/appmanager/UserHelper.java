...
public class UserHelper extends HelperBase {
    ...
    public void delationUser() { click(By.xpath("(//input[@value='Delete'])")); }

    public void modify(int index, UserData contact) {
        selectContactCheckbox(index);
        editUserCheckbox(index);
    ...
    public void submitUserCreation() { wd.findElement(By.xpath("(//input[@name='submit'])[2]")).click(); }

    public void returnToPage() {
        wd.findElement(By.linkText("home page")).click();
    }

    public void editUserCheckbox(int index) { wd.findElements(By.xpath("//img[@alt='Edit']")).get(index).click(); }

    public void selectContactCheckbox(int index) {
        wd.findElements(By.name("selected[]")).get(index).click();
    }

    public void updateUser() { click(By.xpath("//input[@name='update']")); }

    public boolean isThereAUser() { return isElementPresent(By.xpath("//table[@id='maintable']/tbody/tr[2]/td/input")); }
